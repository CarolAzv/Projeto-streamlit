...
class AdminView:
    ...
    def inserir_catogitaUI():
        ...
        if submitted:
            if not descrição:
                ...
                return
        try:   
            AdminView.inserir_catogita(descrição)
    ...
    def inserir_clienteUI():
        ...
        if submitted:
            if not nome or email or senha or fone:
                ...
                return
        try:   
            AdminView.inserir_cliente(nome, email, senha, fone)
    ...
    def inserir_entregadorUI():
        st.title("Criar entregador")
        with st.form("inserir_categoria_form"):
            nome = st.text_input("nome:")
            email = st.text_input("email:")
            senha = st.text_input("senha:")
    ...
    def inserir_produtoUI():
        ...
        if submitted:
            if not id or descricao or preco or estoque:
                ...
                return
        try:   
            AdminView.inserir_produto(descricao, preco, estoque)
    ...
    def atualizar_preçoUI():
        ...
        if submitted:
            if not id or descricao or preco or estoque:
                ...
                return
        try:   
            AdminView.atualizar_preço(id, descricao, preco, estoque)
