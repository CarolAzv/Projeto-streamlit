...
class Categorias:
    ...
    FILE_PATH = 'data/categorias.json'
    ...
    def atualizar(cls, obj):
        ...
        if found:
            ...
            raise ValueError(f"Categoria com ID {obj.get_id()} não encontrada para atualização.")
    ...
    def excluir(cls, obj):
        ...
        if len(cls.objetos) < original_len: 
            ...
            raise ValueError(f"Categoria com ID {obj.get_id()} não encontrada para exclusão.")
    ...
    def buscar_por_categoria(cls,categoria_id):
        cls.abrir()
        return [prod for prod in cls.objeto if prod.get_categoria_id() == categoria_id]
