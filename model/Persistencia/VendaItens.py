import json
import os
from model.Entidades.VendaItem import VendaItem
import streamlit as st

class VendaItens: 
    objetos = []

    FILE_PATH = 'data/vendaitens.json'
    ...
    @classmethod
    def listar_id(cls, id: int) -> VendaItem | None:
        cls.abrir()
    ...
    def atualizar(cls, obj: VendaItem):
        ...
        if found:
            ...
            raise ValueError(f"Item de Venda com ID {obj.get_id()} não encontrado para atualização.")
    ...
    def excluir(cls, obj: VendaItem):
        ...
        if len(cls.objetos) < original_len:
            ...
            raise ValueError(f"Item de Venda com ID {obj.get_id()} não encontrado para exclusão.")
